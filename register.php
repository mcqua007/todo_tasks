...
<html>
<head>
	<title>Welcome to Staqpack</title>
	...
	<div  id="background">
		<div class="container">
			<div class="row" id="loginContainer">
				...
				<div class="col-12 col-md-6" id="inputContainer">
				...
				<div class="col-12 col-md-6" id="loginText">
					<h1 style="font-family: 'Leckerli One', cursive; ">Staqpack</h1>
					<h2>If you think about it, Just do it!</h2>
					<ul>
						<li>Organize Projects</li>
						<li>Create tasks</li>
						<li>Complete To Dos to follow through</li>
					</ul>
				</div>
